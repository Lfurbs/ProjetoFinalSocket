...
public class ServidorB {
    public static void main(String[] args) throws IOException {
        int porta = 6000; // mudar para 7000 no servidor C
    ...
    public static void tratarBusca(Socket socket) {
        try (
            ...
            JSONArray dados = new JSONArray(Files.readString(Paths.get("dados/dados_servidor_b.json"))); // alterar para parte2.json no C
